            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">List of Videos Notes For <i style='color:#c08934'><?php echo $_GET['Nm'];?></i>
                                <?php
                                ...
                                ?><a href="ViewNotes.php?SubjID=<?php echo $_GET['SubjID'].'&Nm='.$_GET['Nm'];?>"><span style="margin-left:30px;"><i class="mdi mdi-file"></i> Files Notes</span></a></h5>
                                <?php
                                    if($_SESSION['Privl'] == "Administrator"){
                                ?>
                                <div class="table-responsive">
                                    ...
                                    <thead>
                                        ...
                                        <tbody>
                                            <?php $call->ViewNotes("Video",$_GET['SubjID']);?>
                                        </tbody>
                                        <tfoot>
                                    </table>
                                </div>
                                <?php
                                    }else{$call->ViewVideosNotes($_GET['SubjID']);}
                                ?>
                            </div>
                        </div>
                    </div>
